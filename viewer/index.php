        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <div class="flex-1 overflow-hidden">
                <?php if ($currentComponent): ?>
                    ...
                    <div id="breakpoint-info" class="px-6 py-2 bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 text-sm text-gray-600 dark:text-gray-400">
                        <span id="current-breakpoint">Desktop</span> • <span id="current-width">1200px</span>
                    </div>

                    <!-- Preview View -->
                    <div id="preview-view" class="h-full flex items-center justify-center p-8 hidden">
                        <div id="component-container" class="breakpoint-container bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden"
                             style="width: 100%; max-width: 100%; height: calc(100vh - 200px);">
                            <iframe id="component-frame" src="api/render.php?category=<?php echo $category; ?>&subcategory=<?php echo $subcategory; ?>&component=<?php echo $component; ?>&theme=<?php echo $theme; ?>"
                    ...
                    <!-- Split View -->
                    <div id="split-view" class="h-full flex flex-col">
                        ...
                        <div id="horizontal-split-container" class="h-full flex flex-col">
                            ...
                            <div id="preview-section" class="flex-1 flex items-center justify-center p-4 border-b border-gray-200 dark:border-gray-700 min-h-0" style="flex: 1 1 50%;">
                                <div id="split-component-container" class="breakpoint-container bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden"
                                     style="width: 100%; max-width: 100%; height: 100%;">
                                    <iframe id="split-component-frame" src="api/render.php?category=<?php echo $category; ?>&subcategory=<?php echo $subcategory; ?>&component=<?php echo $component; ?>&theme=<?php echo $theme; ?>"
                                            class="w-full h-full border-0"></iframe>
                                </div>
                            </div>
                            
                            <!-- Horizontal Resizer -->
                            <div id="horizontal-resizer" class="h-1 bg-gray-300 dark:bg-gray-600 hover:bg-blue-500 cursor-row-resize transition-colors duration-200"></div>
                        ...
                        <!-- Vertical Split -->
                        <div id="vertical-split-container" class="h-full hidden">
                            <!-- Preview Section -->
                            <div id="preview-section-vertical" class="flex-1 flex items-center justify-center p-4 border-r border-gray-200 dark:border-gray-700 min-w-0" style="flex: 1 1 50%;">
                                <div id="split-component-container-vertical" class="breakpoint-container bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden"
                                     style="width: 100%; max-width: 100%; height: 100%;">
                                    <iframe id="split-component-frame-vertical" src="api/render.php?category=<?php echo $category; ?>&subcategory=<?php echo $subcategory; ?>&component=<?php echo $component; ?>&theme=<?php echo $theme; ?>"
                                            class="w-full h-full border-0"></iframe>
                                </div>
                            </div>
                            
                            <!-- Vertical Resizer -->
                            <div id="vertical-resizer" class="w-1 bg-gray-300 dark:bg-gray-600 hover:bg-blue-500 cursor-col-resize transition-colors duration-200"></div>
